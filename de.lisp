...
(
 ...
 (:app-title . "Hiisi")
 (:app-tagline . "Sprachen lernen mit KI-gestützten Übersetzungen")

 ;; Landing page
 (:landing-hero-title . "Jede Sprache meistern")
 (:landing-hero-subtitle . "KI-gestützte Übersetzungen mit detaillierten Grammatikerklärungen und Karteikarten mit Spaced Repetition")
 (:landing-cta . "Jetzt starten")
 (:landing-feature-1-title . "Intelligente Übersetzungen")
 (:landing-feature-1-desc . "Erhalte detaillierte grammatikalische Erklärungen zu Übersetzungen")
 (:landing-feature-2-title . "Spaced Repetition")
 (:landing-feature-2-desc . "Behalte was du lernst mit unserem SM-2 Karteikartensystem")
 (:landing-feature-3-title . "Fortschritt verfolgen")
 (:landing-feature-3-desc . "Überwache deinen Lernfortschritt mit detaillierten Statistiken")
 ...
 (:translate-input-label . "Text zum Übersetzen eingeben")
 (:translate-input-placeholder . "Etwas eingeben...")
 (:translate-from . "Von")
 (:translate-to . "Nach")
 ...
 (:review-no-cards . "Keine Karten zur Wiederholung fällig")
 ...
 (:dashboard-cards-due . "Heute fällige Karten")
 ...
 (:dashboard-streak . "Aktuelle Serie")
 (:dashboard-days . "Tage")

 ;; Subscription
 (:subscribe-title . "Wähle deinen Plan")
 (:subscribe-monthly . "Monatlich")
 (:subscribe-annual . "Jährlich")
 (:subscribe-monthly-price . "10€/Monat")
 (:subscribe-annual-price . "100€/Jahr")
