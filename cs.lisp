...
(:review-session-expired . "Vaše opakovací relace vypršela. Začněte prosím novou relaci.")
 ...
 (:landing-final-cta-subtitle . "Vložte cokoli ve finštině, češtině, polštině nebo v kterémkoli z dvanácti dalších jazyků. Uvidíte, co s tím Hiisi udělá. Sedm dní zdarma.")
 ...
 (:custom-flashcard-update-btn . "Uložit změny")
  ...
  (:coming-soon-badge . "Již brzy")
  (:coming-soon-heading-prefix . "Učte se jazyky")
  (:coming-soon-heading-accent . "tak, jak fungují.")
  (:coming-soon-hero-subtitle . "Hiisi kombinuje strukturované překlady s kartičkami pro intervalové opakování. Každý překlad obsahuje gramatický rozbor slovo po slovu, vzorce skloňování a interaktivní gramatickou wiki.")
  (:coming-soon-get-notified . "Dejte mi vědět")
  (:newsletter-email-label . "E-mailová adresa")
  (:coming-soon-developer-label . "Jsem vývojář")
  (:coming-soon-developer-hint . "posílat technické novinky")
  (:coming-soon-notify-me . "Upozornit mě")
  (:coming-soon-fine-print . "Žádný spam. Jen novinky ke spuštění.")
  (:coming-soon-info-title . "Buďte mezi prvními.")
  (:coming-soon-info-body . "Přihlaste se k novinkám o spuštění. Dáme vám vědět, až bude Hiisi připravené, včetně informací o předběžném přístupu a úvodních cenách.")
  (:coming-soon-features-title . "Čím je Hiisi jiné")
  (:coming-soon-grammar-title . "Gramatické rozbory")
  (:coming-soon-grammar-body . "Každý překlad obsahuje analýzu slovo po slovu: pády, časování a poznámky k použití ve vašem jazyce.")
  (:coming-soon-spaced-title . "Intervalové opakování")
  (:coming-soon-spaced-body . "Ukládejte překlady jako kartičky. Plánování SM-2 je zobrazí ve správný okamžik pro dlouhodobé zapamatování.")
  (:coming-soon-languages-title . "15 jazyků")
  (:coming-soon-languages-body . "Překládejte mezi libovolnou dvojicí. Angličtina, finština, čeština, němčina, španělština, portugalština, italština, ruština, polština, nizozemština, švédština, norština, dánština, estonština.")
  (:newsletter-unsubscribe-page-title . "Odhlásit odběr newsletteru Hiisi")
  (:newsletter-unsubscribe-title . "Odhlásit odběr")
  (:newsletter-unsubscribe-subtitle . "Zadejte e-mail a odhlaste se z novinek o spuštění Hiisi.")
  ...
  (:newsletter-feedback-signed-up . "Jste přihlášeni. Dáme vám vědět, až se Hiisi spustí.")
  (:newsletter-feedback-unsubscribed . "Pokud byl tento e-mail přihlášen, byl odebrán z novinek o spuštění.")
