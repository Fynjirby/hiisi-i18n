...
(
 ...
 (:landing-hero-headline . "Ucte se jazyky komplexne")
 (:landing-hero-subheadline . "Ziskejte preklady s uplnym gramatickym rozkladem a budujte si trvalou slovni zasobu pomoci kartickoveho opakovani.")
 (:landing-hero-trust-line . "7 dni zdarma se 100 preklady. Nutna karta. Zrusit kdykoliv.")
 (:landing-credibility-languages . "14 jazyku")
 (:landing-credibility-ai . "Vcetne gramatickeho rozboru")
 (:landing-credibility-origin . "Vyrobeno v Estonsku")
 (:landing-step-1-title . "Prelozte libovolny text")
 (:landing-step-1-desc . "Zadejte slovo nebo frazi. Ziskejte preklad s uplnym gramatickym rozkladem.")
 (:landing-step-2-title . "Ulozte do kartickek")
 (:landing-step-2-desc . "Ulozte si preklady, ktere si chcete zapamatovat. Karticky se vytvori automaticky.")
 (:landing-step-3-title . "Opakujte a zapamatujte si")
 (:landing-step-3-desc . "Rozlozene opakovani naplanovalo kontroly v idealni chvili pro dlouhodobou pamet.")
 (:landing-feature-grammar-title . "Pochopte gramatiku, nejen slova")
 (:landing-feature-grammar-desc . "Kazdy preklad obsahuje podrobny gramaticky rozklad -- tvary slov, pady, casovani vysvetlene ve vasem jazyce.")
 (:landing-feature-srs-title . "Zapamatovani podlozene vedou")
 (:landing-feature-srs-desc . "Algoritmus rozlozeneho opakovani SM-2 se prisposobi vasemu vykonu. Karticky, se kterymi mate potize, se zobrazi casteji. Karticky, ktere znate, ustoupi.")
 (:landing-feature-share-title . "Sdileni balicku se studenty")
 (:landing-feature-share-desc . "Ucitele mohou vytvorit vlastni balicky kartickek a sdilet je odkazem. Studenti balicek naimportuji a ihned zacnou opakovat.")
 (:landing-pricing-trial-note . "Vcetne 7 dni zkusebni doby zdarma")
 (:landing-pricing-monthly-after . "7 dni zdarma, pak ~A/mesic")
 (:landing-pricing-annual-after . "7 dni zdarma, pak ~A/rok")
 (:landing-faq-title . "Casto kladene otazky")
 (:landing-faq-trial-cap-q . "Kolik prekladu dostanu behem zkusebni doby?")
 (:landing-faq-trial-cap-a . "Behem 7 dni zkusebni doby muzete prelozit az 100 textu. Po predplaceni ziskate 600 mesicne.")
 (:landing-final-cta-title . "Zacnete se ucit jiz dnes")
 (:landing-final-cta-subtitle . "Pridejte se k Hiisi a budujte slovni zasobu, ktera vydrzi.")

 ;; Trial status (in-app)
 (:trial-status . "Zkusebni doba")
 (:trial-days-remaining . "Zbyva ~A dni")
 (:trial-translations-used . "~A/100 pouzitych prekladu")
 (:trial-upgrade-prompt . "Upgradujte a pokracujte v prekladani")
 (:trial-expired . "Vase zkusebni doba skoncila")
 (:trial-expired-detail . "Predplatte si a pokracujte v uceni s Hiisi.")
 (:trial-quota-warning . "Zbyva ~A zkusebnich prekladu (~A dni). Predplatte si 600/mesic.")
 (:trial-quota-exceeded . "Dosazeno limitu zkusebnich prekladu. Predplatte si a pokracujte.")
 (:error-trial-quota-exceeded . "Dosazeno limitu zkusebnich prekladu")
 (:error-trial-quota-detail . "Vyuzili jste vsech 100 zkusebnich prekladu. Predplatte si a pokracujte v uceni.")

 ;; Custom flashcards
 (:custom-flashcard-create-title . "Vytvorit karticku")
 (:custom-flashcard-edit-title . "Upravit karticku")
 (:custom-flashcard-original . "Puvodni text")
 (:custom-flashcard-translated . "Preklad")
 (:custom-flashcard-lang-from . "Zdrojovy jazyk")
 (:custom-flashcard-lang-to . "Cilovy jazyk")
 (:custom-flashcard-note . "Vzdelavaci poznamka")
 (:custom-flashcard-forms . "Gramaticky rozbor")
 (:custom-flashcard-form-term . "Vyraz")
 (:custom-flashcard-form-explanation . "Vysvetleni")
 (:custom-flashcard-add-form . "Pridat gramaticky vyraz")
 (:custom-flashcard-remove-form . "Odstranit")
 (:custom-flashcard-ai-fill . "Vyplnit pomoci AI")
 (:custom-flashcard-ai-fill-all . "Vyplnit vse pomoci AI")
 (:custom-flashcard-ai-fill-translation . "Prelozit pomoci AI")
 (:custom-flashcard-ai-fill-breakdown . "Vygenerovat rozbor")
 (:custom-flashcard-ai-fill-note . "Vygenerovat poznamku")
 (:custom-flashcard-create-btn . "Vytvorit karticku")
 (:custom-flashcard-update-btn . "Ulozit zmeny")
 (:custom-flashcard-delete-btn . "Smazat karticku")
 (:custom-flashcard-delete-confirm . "Opravdu chcete smazat tuto karticku?")
 (:custom-flashcard-created . "Karticka uspesne vytvorena")
 (:custom-flashcard-updated . "Karticka uspesne aktualizovana")
 (:custom-flashcard-deleted . "Karticka uspesne smazana")
 (:custom-flashcard-add-to-deck . "Pridat do balicku")
 (:custom-flashcard-not-found . "Karticka nenalezena")
 (:custom-flashcard-not-owner . "Upravovat muzete pouze karticky, ktere jste vytvorili")
 (:custom-flashcard-ai-generating . "Generovani pomoci AI...")
 (:custom-flashcard-badge . "Vlastni")
