...
(:review-session-expired . "Vaše opakovací relace vypršela. Začněte prosím novou relaci.")
 ...
 (:starter-decks-title . "Oficiální startovací balíčky")
 (:starter-decks-subtitle . "Vyberte jazykovou trojici, procházejte oficiální témata Hiisi a importujte hotové studijní balíčky.")
 (:starter-decks-marketplace-btn . "Oficiální balíčky")
 (:starter-decks-explanation-language . "Jazyk vysvětlení")
 (:starter-decks-search-label . "Hledat")
 (:starter-decks-search-placeholder . "Hledat témata startovacích balíčků")
 (:starter-decks-apply-filters . "Použít filtry")
 (:starter-decks-select-triplet-hint . "Pro náhled balíčku vyberte zdrojový a cílový jazyk.")
 ...
 (:starter-decks-subscribe-detail . "Startovací balíčky jsou dostupné s aktivním předplatným nebo zkušební verzí.")
