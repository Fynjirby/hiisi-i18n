...
(:auth-new-password-same . "Nové heslo se musí lišit od současného hesla.")
 ...
 (:landing-mockup-forgot-detail . "1. osoba jednotného čísla minulého času slovesa „unohtaa“ (zapomenout)")
 (:landing-mockup-keys-detail . "Přivlastňovací přípona -ni na množném kmeni slova „avain“ (klíč)")
 (:landing-mockup-home-detail . "Ilativ slova „koti“ (domov) pro pohyb dovnitř")
 (:landing-mockup-possession-note . "Finština vyjadřuje vlastnictví příponami přímo na podstatném jménu místo samostatných slov.")
 (:landing-mockup-children-detail . "Nominativ plurálu slova \"dítě\"")
 (:landing-mockup-played-detail . "Zvratné minulé, ženský rod množné číslo od \"hrát\"")
 (:landing-mockup-garden-detail . "Lokál slova \"zahrada\" -- místo")
 (:landing-mockup-czech-note . "České sloveso v minulém čase se shoduje s rodem. \"Hrály\" značí ženský rod množného čísla.")
 (:landing-mockup-deck-title . "Základy finštiny")
...
(:review-session-expired . "Vaše opakovací relace vypršela. Začněte prosím novou relaci.")
 ...
 (:landing-hero-trust-line . "7 dní zdarma na zkoušku. Zrušte kdykoliv.")
