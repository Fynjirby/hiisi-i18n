...
(
 ...
 (:app-title . "Hiisi")
 (:app-tagline . "Ucz się języków z tłumaczeniami opartymi na AI")

 ;; Landing page
 (:landing-hero-title . "Opanuj każdy język")
 (:landing-hero-subtitle . "Tłumaczenia AI ze szczegółowymi wyjaśnieniami gramatycznymi i fiszkami z powtórkami rozłożonymi w czasie")
 (:landing-cta . "Zacznij")
 (:landing-feature-1-title . "Inteligentne tłumaczenia")
 (:landing-feature-1-desc . "Otrzymuj szczegółowe wyjaśnienia gramatyczne wraz z tłumaczeniami")
 (:landing-feature-2-title . "Powtórki rozłożone w czasie")
 (:landing-feature-2-desc . "Zapamiętuj to, czego się uczysz dzięki systemowi fiszek SM-2")
 (:landing-feature-3-title . "Śledź postępy")
 (:landing-feature-3-desc . "Monitoruj swoją naukę dzięki szczegółowym statystykom")
 ...
 (:translate-input-label . "Wprowadź tekst do tłumaczenia")
 (:translate-input-placeholder . "Wpisz coś...")
 (:translate-from . "Z")
 (:translate-to . "Na")
 ...
 (:review-complete . "Powtórka zakończona!")
 ...
 (:dashboard-streak . "Aktualna seria")
 (:dashboard-days . "dni")

 ;; Subscription
 (:subscribe-title . "Wybierz plan")
